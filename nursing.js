...
const nursingData = [
    ...
    // ==================== אסתמה ו-COPD (מיקוד למבחן) ====================
    {
        question: "מהי תמונת הגזים באסתמה קלה-בינונית?",
        options: [
            { text: "אלקלוזיס נשימתי — pCO₂ נמוך, pH גבוה (היפרוונטילציה)", correct: true },
            { text: "חמצת נשימתית — pCO₂ גבוה, pH נמוך", correct: false },
            { text: "חמצת מטבולית — HCO₃ נמוך, pH נמוך", correct: false },
            { text: "גזים תקינים לחלוטין", correct: false }
        ],
        category: "אסתמה ו-COPD (מיקוד למבחן)",
        explanation: "באסתמה קלה-בינונית החולה נושם מהר (היפרוונטילציה) → מוציא CO₂ → pCO₂ יורד → pH עולה = אלקלוזיס נשימתי."
    },
    {
        question: "מהי תמונת הגזים באסתמה קשה?",
        options: [
            { text: "pCO₂ תקין (נורמוקפניה) — סימן מאיים! השרירים מתעייפים", correct: true },
            { text: "pCO₂ נמוך מאוד — היפרוונטילציה קיצונית", correct: false },
            { text: "pH גבוה מאוד — אלקלוזיס חמור", correct: false },
            { text: "גזים תקינים — אין סכנה", correct: false }
        ],
        category: "אסתמה ו-COPD (מיקוד למבחן)",
        explanation: "באסתמה קשה, pCO₂ תקין הוא סימן מאיים (ולא מרגיע!) — החולה כבר לא מצליח לפצות בהיפרוונטילציה כי שרירי הנשימה מתעייפים. זהו שלב מעבר לכשל נשימתי."
    },
    {
        question: "מהי תמונת הגזים באסתמה קשה מאוד / כשל נשימתי ממשמש ובא?",
        options: [
            { text: "חמצת נשימתית — pCO₂ גבוה, pH נמוך, סטורציה נמוכה", correct: true },
            { text: "אלקלוזיס נשימתי — pCO₂ נמוך", correct: false },
            { text: "אלקלוזיס מטבולי — HCO₃ גבוה", correct: false },
            { text: "גזים תקינים", correct: false }
        ],
        category: "אסתמה ו-COPD (מיקוד למבחן)",
        explanation: "באסתמה קשה מאוד: שרירי הנשימה נכשלים → CO₂ מצטבר → חמצת נשימתית (pCO₂ גבוה, pH נמוך). זהו מצב חירום הדורש אינטובציה דחופה."
    },
    {
        question: "מהו ההבדל העיקרי בין אסתמה ל-COPD?",
        options: [
            { text: "אסתמה — הפיכה, מתחילה צעיר, התקפית; COPD — בלתי הפיכה, מתחילה מבוגר, מתמשכת", correct: true },
            { text: "אסתמה — לא מגיבה לטיפול; COPD — מגיבה לברונכודילטורים", correct: false },
            { text: "אסתמה — רק מעשנים; COPD — רק אלרגיים", correct: false },
            { text: "אין הבדל קליני משמעותי", correct: false }
        ],
        category: "אסתמה ו-COPD (מיקוד למבחן)",
        explanation: "אסתמה: חסימה הפיכה, מתחילה בגיל צעיר, מופעלת מטריגרים (אלרגנים, מאמץ), תקינה בין ההתקפים, מגיבה היטב לברונכודילטורים. COPD: חסימה בלתי הפיכה ומתקדמת, מבוגרים, קשורה לעישון, תסמינים מתמשכים."
    },
    {
        question: "מהו הטיפול בהתקף אסתמה?",
        options: [
            { text: "ונטולין (Salbutamol), אירובנט (Ipratropium), סטרואידים; במצב קשה — אמינופילין ומגנזיום IV", correct: true },
            { text: "אנטיביוטיקה בלבד", correct: false },
            { text: "חמצן בריכוז גבוה בלבד", correct: false },
            { text: "משתנים ונוזלים", correct: false }
        ],
        category: "אסתמה ו-COPD (מיקוד למבחן)",
        explanation: "טיפול באסתמה: 1) ונטולין (Salbutamol) — אגוניסט בטא-2 קצר טווח, מרחיב סמפונות. 2) אירובנט (Ipratropium) — אנטי-כולינרגי, מרחיב סמפונות. 3) סטרואידים (IV/פומי). 4) במצב קשה: אמינופילין IV ומגנזיום IV להרפיית שריר חלק."
    },
    {
        question: "מהו תפקיד המגנזיום IV בטיפול באסתמה קשה?",
        options: [
            { text: "הרפיית שריר חלק של דרכי האוויר (ברונכודילטציה)", correct: true },
            { text: "תיקון היפומגנזמיה בלבד", correct: false },
            { text: "הורדת חום", correct: false },
            { text: "מניעת הפרעות קצב", correct: false }
        ],
        category: "אסתמה ו-COPD (מיקוד למבחן)",
        explanation: "מגנזיום IV ניתן באסתמה קשה שלא מגיבה לטיפול ראשוני. הוא גורם להרפיית שריר חלק של דרכי האוויר (ברונכודילטציה)."
    },
    {
        question: "מהו תפקיד הוונטולין (Salbutamol) בטיפול באסתמה?",
        options: [
            { text: "אגוניסט בטא-2 קצר טווח — מרחיב סמפונות במהירות", correct: true },
            { text: "אנטי-כולינרגי — מייבש הפרשות", correct: false },
            { text: "סטרואיד — מפחית דלקת", correct: false },
            { text: "אנטיביוטיקה — מטפל בזיהום", correct: false }
        ],
        category: "אסתמה ו-COPD (מיקוד למבחן)",
        explanation: "ונטולין (Salbutamol) הוא אגוניסט בטא-2 קצר טווח (SABA). מרחיב את הסמפונות במהירות, תרופת הצלה ראשונה בהתקף אסתמה."
    },
    {
        question: "מהו תפקיד האירובנט (Ipratropium) בטיפול באסתמה?",
        options: [
            { text: "אנטי-כולינרגי — מרחיב סמפונות ומפחית הפרשות", correct: true },
            { text: "אגוניסט בטא-2 — מרחיב סמפונות", correct: false },
            { text: "סטרואיד — מפחית דלקת", correct: false },
            { text: "מעכב לויקוטריאנים", correct: false }
        ],
        category: "אסתמה ו-COPD (מיקוד למבחן)",
        explanation: "אירובנט (Ipratropium/Atrovent) הוא אנטי-כולינרגי (אנטימוסקריני). מרחיב סמפונות ומפחית הפרשות. ניתן יחד עם ונטולין בהתקף בינוני-קשה."
    },
    {
        question: "בחולה COPD, מהו הדגש החשוב במתן חמצן?",
        options: [
            { text: "ריכוז מדויק ומבוקר (מסכת ונטורי) — סכנת דיכוי נשימתי ממתן חמצן גבוה", correct: true },
            { text: "ריכוז גבוה ככל האפשר", correct: false },
            { text: "אין צורך בחמצן לחולי COPD", correct: false },
            { text: "מתן חמצן 100% תמיד", correct: false }
        ],
        category: "אסתמה ו-COPD (מיקוד למבחן)",
        explanation: "בחולי COPD הנשימה מונעת על ידי היפוקסיה (Hypoxic Drive). מתן חמצן בריכוז גבוה מדי עלול לגרום לדיכוי נשימתי (Oxygen Induced Hypoventilation). לכן ניתן חמצן בריכוז מדויק ומבוקר — מסכת ונטורי."
    },
    {
        question: "מתי ניתנת מסכת BiPAP לחולה COPD?",
        options: [
            { text: "תמיד בהחמרת COPD — תמיכה לא-פולשנית בנשימה עם שני לחצים (שאיפה ונשיפה)", correct: true },
            { text: "רק כשהחולה מונשם", correct: false },
            { text: "רק לחולי אסתמה", correct: false },
            { text: "רק אחרי אינטובציה", correct: false }
        ],
        category: "אסתמה ו-COPD (מיקוד למבחן)",
        explanation: "BiPAP (Bilevel Positive Airway Pressure) ניתנת בהחמרת COPD כתמיכה נשימתית לא-פולשנית. מספקת שני לחצים: לחץ גבוה בשאיפה (IPAP) ולחץ נמוך בנשיפה (EPAP), עוזרת להוציא CO₂."
    },
    {
        question: "מתי ניתנת מסכת CPAP לחולה COPD?",
        options: [
            { text: "חולה COPD עם BMI גבוה ונטייה להפסקות נשימה (סכנת צניחת לשון)", correct: true },
            { text: "כל חולה COPD", correct: false },
            { text: "רק חולה COPD עם חום", correct: false },
            { text: "רק חולה COPD לאחר ניתוח", correct: false }
        ],
        category: "אסתמה ו-COPD (מיקוד למבחן)",
        explanation: "CPAP (Continuous Positive Airway Pressure) ניתנת לחולה COPD עם BMI גבוה ונטייה להפסקות נשימה בשינה (דום נשימה חסימתי), בגלל סיכון לצניחת לשון. CPAP שומרת על לחץ חיובי קבוע שמונע קריסת דרכי האוויר."
    },
    {
        question: "מתי משתמשים במסכת אוהל (Face Tent)?",
        options: [
            { text: "בחולה עם שבר בפנים — כשלא ניתן להרכיב מסכה רגילה על הפנים", correct: true },
            { text: "בכל חולה COPD", correct: false },
            { text: "בחולה מונשם", correct: false },
            { text: "בחולה לאחר ניתוח לב", correct: false }
        ],
        category: "אסתמה ו-COPD (מיקוד למבחן)",
        explanation: "מסכת אוהל (Face Tent) משמשת כשלא ניתן להרכיב מסכה רגילה על הפנים — למשל במקרה של שבר בפנים, כוויות פנים, או ניתוח פנים. המסכה יוצרת 'אוהל' מסביב לפנים ללא מגע ישיר."
    },
    {
        question: "מהי אינדיקציה לאינטובציה?",
        options: [
            { text: "כשל נשימתי, חוסר יכולת לשמור על נתיב אוויר, GCS ≤ 8, היפוקסיה שלא מגיבה לטיפול", correct: true },
            { text: "כל חולה עם קוצר נשימה", correct: false },
            { text: "חום גבוה בלבד", correct: false },
            { text: "אסתמה קלה", correct: false }
        ],
        category: "אסתמה ו-COPD (מיקוד למבחן)",
        explanation: "אינדיקציות לאינטובציה: כשל נשימתי (pCO₂ עולה, סטורציה יורדת למרות טיפול), חוסר יכולת לשמור על נתיב אוויר פתוח, ירידה בהכרה (GCS ≤ 8), הגנה על דרכי אוויר מפני אספירציה."
    },
    {
        question: "מה חשוב לעשות לפני ביצוע אינטובציה?",
        options: [
            { text: "להעלות קודם את הסטורציה (Pre-oxygenation) — לא לסכן את חיי החולה", correct: true },
            { text: "לבצע אינטובציה מיד ללא הכנה", correct: false },
            { text: "להוריד את לחץ הדם", correct: false },
            { text: "להפסיק את כל התרופות", correct: false }
        ],
        category: "אסתמה ו-COPD (מיקוד למבחן)",
        explanation: "תמיד מעלים קודם את הסטורציה (Pre-oxygenation) — חמצון מקדים באמצעות מסכה בריכוז גבוה — ורק אז מבצעים אינטובציה, כדי לא לסכן את חיי החולה בזמן ההליך."
    },
    {
        question: "מתי ניתנת מסכת Non-Rebreather עם שסתום?",
        options: [
            { text: "למטופל במצב מתדרדר העומד בפני אינטובציה — ריכוז חמצן 90-100%", correct: true },
            { text: "לחולה COPD יציב", correct: false },
            { text: "לכל חולה אחרי ניתוח", correct: false },
            { text: "לחולה עם שבר בפנים", correct: false }
        ],
        category: "אסתמה ו-COPD (מיקוד למבחן)",
        explanation: "מסכת Non-Rebreather עם שסתום חד-כיווני ושקית העשרה מספקת 90-100% חמצן. ניתנת למטופל במצב מתדרדר העומד בפני אינטובציה — הריכוז הגבוה ביותר שניתן להשיג ללא הנשמה."
    },
    {
        question: "מהי תמונת הגזים של חולה COPD מחמיר?",
        options: [
            { text: "חמצת נשימתית כרונית מפוצחת — pCO₂ גבוה, HCO₃ גבוה (פיצוי כלייתי), pH קרוב לתקין", correct: true },
            { text: "אלקלוזיס נשימתי — pCO₂ נמוך", correct: false },
            { text: "חמצת מטבולית — HCO₃ נמוך", correct: false },
            { text: "גזים תקינים לחלוטין", correct: false }
        ],
        category: "אסתמה ו-COPD (מיקוד למבחן)",
        explanation: "חולה COPD כרוני: חמצת נשימתית כרונית — pCO₂ גבוה באופן קבוע. הכליות מפצות ע\"י עליית HCO₃ → pH קרוב לתקין. בהחמרה: pCO₂ עולה עוד, הפיצוי לא מספיק → pH יורד."
    },
    {
        question: "מהו ההבדל בתמונת הגזים בין חולה COPD מונשם לחולה אסתמה מונשם?",
        options: [
            { text: "COPD — pCO₂ גבוה כרוני עם HCO₃ מפוצה; אסתמה — pCO₂ גבוה חריף ללא פיצוי כלייתי", correct: true },
            { text: "שניהם — pCO₂ נמוך", correct: false },
            { text: "COPD — חמצת מטבולית; אסתמה — אלקלוזיס מטבולי", correct: false },
            { text: "אין הבדל בגזים", correct: false }
        ],
        category: "אסתמה ו-COPD (מיקוד למבחן)",
        explanation: "COPD מונשם: חמצת נשימתית כרונית — pCO₂ גבוה עם HCO₃ גבוה (פיצוי כלייתי), pH מתון. אסתמה מונשם: חמצת נשימתית חריפה — pCO₂ גבוה עם HCO₃ תקין (לא הספיק להתפתח פיצוי), pH נמוך יותר."
    },
    // ==================== תרופות סוכרת (מיקוד למבחן) ====================
    {
        question: "מהי התרופה הראשונה בקו הטיפול בסוכרת סוג 2?",
        options: [
            { text: "מטפורמין (Metformin/Glucophage) — מפחית ייצור גלוקוז בכבד ומגביר רגישות לאינסולין", correct: true },
            { text: "אינסולין", correct: false },
            { text: "סולפונילאוריאה (Glibenclamide)", correct: false },
            { text: "SGLT2 מעכבים", correct: false }
        ],
        category: "תרופות סוכרת (מיקוד למבחן)",
        explanation: "מטפורמין הוא קו ראשון בסוכרת סוג 2. מנגנון: מפחית ייצור גלוקוז בכבד, מגביר רגישות לאינסולין בשריר. יתרון: לא גורם להיפוגליקמיה לבד, לא מעלה משקל."
    },
    {
        question: "מתי אסור לתת מטפורמין?",
        options: [
            { text: "אי-ספיקת כליה (eGFR < 30), אי-ספיקת כבד, לפני/אחרי חומר ניגוד, חמצת לקטית", correct: true },
            { text: "אסור רק בהריון", correct: false },
            { text: "אסור רק באלרגיה לתרופה", correct: false },
            { text: "אסור בכל סוג סוכרת", correct: false }
        ],
        category: "תרופות סוכרת (מיקוד למבחן)",
        explanation: "התוויות נגד למטפורמין: אי-ספיקת כליה (eGFR < 30 — סיכון להצטברות וחמצת לקטית), אי-ספיקת כבד חמורה, לפני/אחרי חומר ניגוד (השהייה ~48 שעות), מצבי היפוקסיה חמורים (הלם, ספסיס)."
    },
    {
        question: "מה ניתן כחלופה למטפורמין כשהוא לא מתאים למצב הקליני?",
        options: [
            { text: "סולפונילאוריאה, DPP-4 מעכבים (גליפטינים), SGLT2 מעכבים, GLP-1 אגוניסטים, או אינסולין", correct: true },
            { text: "אין חלופות — רק דיאטה", correct: false },
            { text: "אנטיביוטיקה", correct: false },
            { text: "סטרואידים", correct: false }
        ],
        category: "תרופות סוכרת (מיקוד למבחן)",
        explanation: "חלופות למטפורמין: סולפונילאוריאה (Glibenclamide — מגרה הפרשת אינסולין, סיכון להיפוגליקמיה), DPP-4 מעכבים (Januvia), SGLT2 מעכבים (Jardiance — הגנה כלייתית ולבבית), GLP-1 אגוניסטים (Victoza), או אינסולין."
    },
    {
        question: "מהי הסכנה העיקרית של סולפונילאוריאה (Glibenclamide)?",
        options: [
            { text: "היפוגליקמיה — מגרה הפרשת אינסולין ללא תלות ברמת הסוכר", correct: true },
            { text: "חמצת לקטית", correct: false },
            { text: "זיהום בדרכי שתן", correct: false },
            { text: "עלייה בלחץ דם", correct: false }
        ],
        category: "תרופות סוכרת (מיקוד למבחן)",
        explanation: "סולפונילאוריאה (Glibenclamide, Glimepiride) מגרה הפרשת אינסולין מהלבלב ללא תלות ברמת הסוכר → סיכון להיפוגליקמיה, במיוחד בקשישים ובחולי כליה."
    },
    {
        question: "מהו היתרון המיוחד של תרופות SGLT2 מעכבים (כמו Jardiance/Empagliflozin)?",
        options: [
            { text: "הגנה כלייתית ולבבית, ירידה במשקל, סיכון נמוך להיפוגליקמיה", correct: true },
            { text: "הורדת סוכר מהירה ביותר", correct: false },
            { text: "מחיר נמוך", correct: false },
            { text: "ללא תופעות לוואי", correct: false }
        ],
        category: "תרופות סוכרת (מיקוד למבחן)",
        explanation: "SGLT2 מעכבים (Empagliflozin/Jardiance, Dapagliflozin/Forxiga) — מונעים ספיגה חוזרת של גלוקוז בכליה → סוכר יוצא בשתן. יתרונות: הגנה כלייתית ולבבית, ירידה במשקל, ל\"ד יורד. חיסרון: סיכון לזיהומי שתן ופטרת."
    },
    {
        question: "מהם יעדי שומני הדם LDL ו-HDL בחולה סוכרתי?",
        options: [
            { text: "LDL < 100 (או <70 בסיכון גבוה); HDL > 40 בגברים, > 50 בנשים", correct: true },
            { text: "LDL < 200; HDL > 20", correct: false },
            { text: "LDL < 150; HDL לא חשוב", correct: false },
            { text: "LDL ו-HDL לא רלוונטיים בסוכרת", correct: false }
        ],
        category: "תרופות סוכרת (מיקוד למבחן)",
        explanation: "בחולה סוכרתי: LDL < 100 mg/dL (או < 70 בסיכון קרדיווסקולרי גבוה). HDL > 40 בגברים, > 50 בנשים (HDL הוא הכולסטרול 'הטוב' — ככל שגבוה יותר, טוב יותר). טריגליצרידים < 150."
    },
    {
        question: "מהו פרוטוקול השהיית מטפורמין סביב חומר ניגוד?",
        options: [
            { text: "בדיקת eGFR לפני, השהיה ~48 שעות אחרי, חידוש רק לאחר וידוא תפקוד כליה תקין + הידרציה", correct: true },
            { text: "הפסקה שבוע לפני ושבוע אחרי", correct: false },
            { text: "אין צורך בהפסקה כלל", correct: false },
            { text: "הפסקה רק ביום הבדיקה", correct: false }
        ],
        category: "תרופות סוכרת (מיקוד למבחן)",
        explanation: "פרוטוקול מטפורמין וחומר ניגוד: 1) בדיקת תפקוד כליה (eGFR/קריאטינין) לפני הבדיקה. 2) השהיית מטפורמין סביב הבדיקה (~48 שעות אחרי חומר הניגוד). 3) חידוש רק לאחר וידוא תפקוד כליה תקין. 4) הידרציה (מתן נוזלים) להגנה על הכליה."
    },
    // ==================== תיקון נתרן ו-ODS ====================
    {
        question: "מהו פרוטוקול הניטור בתיקון היפונתרמיה למניעת ODS?",
        options: [
            { text: "ניטור סימנים חיוניים, בדיקת נתרן תכופה, ובדיקת אישונים כל שעתיים", correct: true },
            { text: "בדיקת סוכר כל שעה בלבד", correct: false },
            { text: "ניטור דופק בלבד", correct: false },
            { text: "אין צורך בניטור מיוחד", correct: false }
        ],
        category: "הערכה סיעודית",
        explanation: "בתיקון היפונתרמיה: 1) קצב עלייה מבוקר — לא יותר מ-8-10 mEq/L ביממה. 2) מעקב על סימנים חיוניים. 3) ניטור נתרן תכוף (כל 2-4 שעות). 4) בדיקת אישונים כל שעתיים לזיהוי סימנים נוירולוגיים מוקדמים של ODS."
    },
    {
        question: "מהם הסימנים הנוירולוגיים של ODS (Osmotic Demyelination Syndrome)?",
        options: [
            { text: "דיסארתריה, דיספגיה, שיתוק, שינויים באישונים, ירידה בהכרה", correct: true },
            { text: "כאב בטן ושלשולים", correct: false },
            { text: "חום גבוה ופריחה", correct: false },
            { text: "כאב חזה וקוצר נשימה", correct: false }
        ],
        category: "הערכה סיעודית",
        explanation: "ODS (תסמונת דמילינציה אוסמוטית / Central Pontine Myelinolysis) — נזק מוחי מתיקון מהיר מדי של נתרן. סימנים: קשיי דיבור (דיסארתריה), קשיי בליעה (דיספגיה), שיתוק, שינויים באישונים, ירידה בהכרה — נזק בלתי הפיך."
    },
    // ==================== אי-ספיקת כליות — זיהוי לפי נתרן ====================
    {
        question: "כיצד מזהים AKI טרום-כלייתי (Pre-renal) לפי נתרן בשתן?",
        options: [
            { text: "נתרן בשתן נמוך (< 20 mEq/L) ו-FENa < 1% — הכליה שומרת נתרן כי יש ירידה בזרימה", correct: true },
            { text: "נתרן בשתן גבוה (> 40 mEq/L)", correct: false },
            { text: "נתרן בשתן תקין", correct: false },
            { text: "לא ניתן לזהות לפי נתרן", correct: false }
        ],
        category: "אי-ספיקת כליות",
        explanation: "ב-Pre-renal AKI הכליה תקינה אך 'מורעבת' מדם → היא שומרת על נתרן ומים (ספיגה חוזרת מקסימלית). לכן: נתרן בשתן נמוך (< 20 mEq/L), FENa < 1%, אוסמולריות שתן גבוהה, שתן מרוכז."
    },
    {
        question: "כיצד מזהים AKI תוך-כלייתי (Intra-renal / ATN) לפי נתרן בשתן?",
        options: [
            { text: "נתרן בשתן גבוה (> 40 mEq/L) ו-FENa > 2% — הכליה פגועה ולא יכולה לספוג נתרן", correct: true },
            { text: "נתרן בשתן נמוך (< 20 mEq/L)", correct: false },
            { text: "נתרן בשתן תקין", correct: false },
            { text: "FENa < 1%", correct: false }
        ],
        category: "אי-ספיקת כליות",
        explanation: "ב-Intra-renal AKI (ATN) הכליה עצמה פגועה → לא מצליחה לספוג נתרן חזרה. לכן: נתרן בשתן גבוה (> 40 mEq/L), FENa > 2%, אוסמולריות שתן נמוכה, שתן מדולל."
    },
    {
        question: "מהו FENa ומה הוא מרמז?",
        options: [
            { text: "Fractional Excretion of Sodium — מבדיל בין AKI טרום-כלייתי (<1%) לתוך-כלייתי (>2%)", correct: true },
            { text: "מדד לתפקוד לבבי", correct: false },
            { text: "מדד לרמת נתרן בדם", correct: false },
            { text: "מדד לתפקוד כבדי", correct: false }
        ],
        category: "אי-ספיקת כליות",
        explanation: "FENa (Fractional Excretion of Sodium) — אחוז הנתרן שהכליה מפרישה מתוך מה שמסונן. FENa < 1% = Pre-renal (הכליה שומרת נתרן). FENa > 2% = Intra-renal/ATN (הכליה לא יכולה לספוג). FENa הוא הכלי המעבדתי המרכזי להבחנה."
    },
    {
        question: "כיצד מאבחנים AKI בתר-כלייתי (Post-renal)?",
        options: [
            { text: "בהדמיה (אולטרסאונד) — הידרונפרוזיס (הרחבת אגן הכליה מחסימה)", correct: true },
            { text: "לפי נתרן בשתן בלבד", correct: false },
            { text: "לפי FENa בלבד", correct: false },
            { text: "לפי בדיקת דם בלבד", correct: false }
        ],
        category: "אי-ספיקת כליות",
        explanation: "AKI בתר-כלייתי (Post-renal) — חסימה ביציאת השתן (אבנים, ערמונית מוגדלת, גידול). אבחנה: אולטרסאונד המראה הידרונפרוזיס (הרחבת אגן הכליה). נתרן בשתן משתנה ולא אבחנתי בשלב זה."
    },
    // ==================== לבלב ====================
    {
        question: "מהם ממצאי המעבדה האופייניים לדלקת לבלב חריפה (פנקראטיטיס)?",
        options: [
            { text: "עמילאז (Amylase) ועליפאז (Lipase) גבוהים — ליפאז ספציפי יותר", correct: true },
            { text: "המוגלובין נמוך בלבד", correct: false },
            { text: "WBC נמוך ו-CRP נמוך", correct: false },
            { text: "נתרן גבוה ואשלגן נמוך בלבד", correct: false }
        ],
        category: "לבלב (מיקוד למבחן)",
        explanation: "בפנקראטיטיס חריפה: עמילאז (Amylase) ↑ וליפאז (Lipase) ↑ — ליפאז ספציפי יותר ללבלב ונשאר מוגבר זמן רב יותר. בנוסף: WBC ↑, CRP ↑, לעיתים עלייה בבילירובין ובאנזימי כבד (אם הסיבה היא אבני מרה)."
    },
    {
        question: "מהם שני הגורמים השכיחים ביותר לפנקראטיטיס חריפה?",
        options: [
            { text: "אבני מרה ואלכוהול", correct: true },
            { text: "סוכרת ויתר לחץ דם", correct: false },
            { text: "זיהום ויראלי ותרופות", correct: false },
            { text: "עישון ושמנות", correct: false }
        ],
        category: "לבלב (מיקוד למבחן)",
        explanation: "שני הגורמים השכיחים ביותר לפנקראטיטיס חריפה: 1) אבני מרה (Gallstones) — חסימת צינור המרה-לבלב. 2) אלכוהול — פגיעה ישירה ברקמת הלבלב. יחד אחראיים ל-~80% מהמקרים."
    },
    {
        question: "מהי הפרעת האלקטרוליטים האופיינית בפנקראטיטיס חריפה?",
        options: [
            { text: "היפוקלצמיה — סידן נקשר לרקמת שומן נמקית (סבון סידן)", correct: true },
            { text: "היפרקלצמיה", correct: false },
            { text: "היפרנתרמיה", correct: false },
            { text: "היפוקלמיה בלבד", correct: false }
        ],
        category: "לבלב (מיקוד למבחן)",
        explanation: "בפנקראטיטיס חריפה: היפוקלצמיה — סידן נקשר לרקמת שומן נמקית (saponification/סיבון סידן). זהו סימן מאיים לחומרה. מופיעה גם היפומגנזמיה."
    },
    {
        question: "מהם הסימנים הקליניים של פנקראטיטיס חריפה?",
        options: [
            { text: "כאב אפיגסטרי חד מוקרן לגב, בחילות והקאות, הגנת בטן, חום", correct: true },
            { text: "כאב חזה וקוצר נשימה", correct: false },
            { text: "שלשולים דמיים בלבד", correct: false },
            { text: "צהבת ללא כאב", correct: false }
        ],
        category: "לבלב (מיקוד למבחן)",
        explanation: "פנקראטיטיס חריפה: כאב אפיגסטרי (בטן עליונה) חד מוקרן לגב, מחמיר בשכיבה ומוקל בישיבה קדימה. בחילות והקאות, הגנת בטן, חום. סימנים חמורים: סימן Cullen (כחלון סביב הטבור) וסימן Grey Turner (כחלון באגפי הבטן) — מעידים על דימום רטרופריטוניאלי."
    },
    {
        question: "מהם סימן Cullen וסימן Grey Turner ומה הם מרמזים?",
        options: [
            { text: "כחלון סביב הטבור (Cullen) ובאגפי הבטן (Grey Turner) — דימום רטרופריטוניאלי בפנקראטיטיס קשה", correct: true },
            { text: "פריחה אלרגית", correct: false },
            { text: "סימנים של דלקת ריאות", correct: false },
            { text: "סימנים של אי-ספיקת כליה", correct: false }
        ],
        category: "לבלב (מיקוד למבחן)",
        explanation: "סימן Cullen — כחלון (ecchymosis) סביב הטבור. סימן Grey Turner — כחלון באגפי הבטן (צדדים). שניהם מרמזים על דימום רטרופריטוניאלי ומעידים על פנקראטיטיס נמקית חמורה — פרוגנוזה גרועה."
    },
    {
        question: "מהו הטיפול הראשוני בפנקראטיטיס חריפה?",
        options: [
            { text: "צום, נוזלים IV אגרסיביים, שיכוך כאב, ניטור אלקטרוליטים (סידן!)", correct: true },
            { text: "ניתוח דחוף תמיד", correct: false },
            { text: "אנטיביוטיקה מיידית בכל מקרה", correct: false },
            { text: "האכלה מיידית", correct: false }
        ],
        category: "לבלב (מיקוד למבחן)",
        explanation: "טיפול בפנקראטיטיס חריפה: 1) צום (NPO — מנוחה ללבלב). 2) נוזלים IV אגרסיביים. 3) שיכוך כאב (להימנע ממורפין — עלול לגרום לכווץ סוגר Oddi). 4) ניטור ותיקון אלקטרוליטים — במיוחד סידן. 5) אנטיביוטיקה רק בחשד לנמק מזוהם."
    },
    // ==================== דיאליזה חירום (מיקוד למבחן) ====================
    {
        question: "מהן האינדיקציות לדיאליזה חירום? (מנמוניק AEIOU)",
        options: [
            { text: "A-חמצת, E-אלקטרוליטים (היפרקלמיה), I-הרעלה, O-עומס נוזלים, U-אורמיה", correct: true },
            { text: "אנמיה, אלקלוזיס, זיהום, אוליגוריה, אורטיקריה", correct: false },
            { text: "אסתמה, אפילפסיה, אי-ספיקת לב, אוסטאופורוזיס, אורתוסטטיזם", correct: false },
            { text: "רק כשקריאטינין מעל 10", correct: false }
        ],
        category: "דיאליזה חירום (מיקוד למבחן)",
        explanation: "AEIOU — A: Acidosis (חמצת pH < 7.2 עמידה לטיפול), E: Electrolytes (היפרקלמיה > 6.5 mEq/L או עם שינויי ECG), I: Intoxication (הרעלה מליתיום, אתילן גליקול, מתנול), O: Overload (עומס נוזלים ובצקת ריאות עמידים למשתנים), U: Uremia (אורמיה עם תסמינים — אנצפלופתיה, פריקרדיטיס, דימומים)."
    },
    {
        question: "באיזה pH מהווה חמצת אינדיקציה לדיאליזה חירום?",
        options: [
            { text: "pH < 7.2 שלא מגיב לטיפול בביקרבונט", correct: true },
            { text: "pH < 7.35", correct: false },
            { text: "pH < 7.45", correct: false },
            { text: "pH < 7.0 בלבד", correct: false }
        ],
        category: "דיאליזה חירום (מיקוד למבחן)",
        explanation: "חמצת חמורה (pH < 7.2) שעמידה לטיפול בביקרבונט, או מצב בו לא ניתן לתת ביקרבונט (עומס נוזלים) — אינדיקציה לדיאליזה חירום."
    },
    {
        question: "באיזו רמת אשלגן מהווה היפרקלמיה אינדיקציה לדיאליזה חירום?",
        options: [
            { text: "K > 6.5 mEq/L, או נמוך יותר עם שינויי ECG", correct: true },
            { text: "K > 5.0 mEq/L תמיד", correct: false },
            { text: "K > 4.5 mEq/L", correct: false },
            { text: "רק K > 8.0 mEq/L", correct: false }
        ],
        category: "דיאליזה חירום (מיקוד למבחן)",
        explanation: "היפרקלמיה > 6.5 mEq/L שלא מגיבה לטיפול תרופתי (סלבוטמול, אינסולין+גלוקוז, קיילקסלט), או רמות נמוכות יותר עם שינויי ECG (גלי T שפודיים, QRS רחב) — אינדיקציה לדיאליזה חירום."
    },
    {
        question: "אילו הרעלות מהוות אינדיקציה לדיאליזה חירום?",
        options: [
            { text: "ליתיום, אתילן גליקול (נוגד קפיאה), מתנול, אספירין (סליצילטים)", correct: true },
            { text: "פרצטמול בלבד", correct: false },
            { text: "כל תרופה במינון יתר", correct: false },
            { text: "אלכוהול (אתנול) בלבד", correct: false }
        ],
        category: "דיאליזה חירום (מיקוד למבחן)",
        explanation: "הרעלות המחייבות דיאליזה: ליתיום (תרופה פסיכיאטרית), אתילן גליקול (נוגד קפיאה — גורם חמצת ואי-ספיקת כליה), מתנול (חמצת וסמיות), סליצילטים במינון גבוה. דיאליזה מסירה את הרעל ישירות מהדם."
    },
    {
        question: "מהם תסמיני אורמיה המחייבים דיאליזה?",
        options: [
            { text: "אנצפלופתיה אורמית, פריקרדיטיס אורמית, דימומים אורמיים, בחילות והקאות עמידות", correct: true },
            { text: "עייפות קלה בלבד", correct: false },
            { text: "כאב ראש בלבד", correct: false },
            { text: "עלייה קלה בקריאטינין ללא תסמינים", correct: false }
        ],
        category: "דיאליזה חירום (מיקוד למבחן)",
        explanation: "אורמיה (הצטברות פסולת חנקנית) עם תסמינים חמורים: אנצפלופתיה (בלבול, עוויתות, תרדמת), פריקרדיטיס (חיכוך פריקרדיאלי — סכנת טמפונדה), דימומים (הפרעה בתפקוד טסיות), בחילות והקאות עמידות — מחייבים דיאליזה."
    },
    // ==================== סוגי אינסולין (מיקוד למבחן) ====================
    {
        question: "מהו סוג האינסולין היחיד שניתן לתת IV?",
        options: [
            { text: "אינסולין רגולר (Regular — Humulin R / Novolin R) — קצר טווח", correct: true },
            { text: "אינסולין NPH — בינוני טווח", correct: false },
            { text: "אינסולין Lantus — ארוך טווח", correct: false },
            { text: "אינסולין Humalog — מהיר טווח", correct: false }
        ],
        category: "סוגי אינסולין (מיקוד למבחן)",
        explanation: "אינסולין רגולר (Regular) הוא האינסולין היחיד שניתן IV. משמש בטפטוף IV רציף בטיפול ב-DKA. התחלת פעולה: ~30 דקות, שיא: ~2 שעות, משך: ~8 שעות."
    },
    {
        question: "מהם סוגי האינסולין מהיר הפעולה (Rapid-Acting)?",
        options: [
            { text: "Humalog (Lispro), Novolog (Aspart), Apidra (Glulisine) — התחלה: 15 דקות, שיא: שעה", correct: true },
            { text: "Regular insulin — התחלה 30 דקות", correct: false },
            { text: "NPH — התחלה שעתיים", correct: false },
            { text: "Lantus — ללא שיא", correct: false }
        ],
        category: "סוגי אינסולין (מיקוד למבחן)",
        explanation: "אינסולין מהיר (Rapid-Acting): Humalog (Lispro), Novolog (Aspart), Apidra (Glulisine). התחלה: ~15 דקות, שיא: ~1 שעה, משך: ~3 שעות. ניתן ממש לפני הארוחה. טיפ: 'חם-ל' = חומלוג-ליספרו, 'נובו-א' = נובולוג-אספרט."
    },
    {
        question: "מהם המאפיינים של אינסולין NPH (בינוני טווח)?",
        options: [
            { text: "התחלה: ~2 שעות, שיא: ~8 שעות, משך: ~16 שעות — עכור, ניתן לערבב עם Regular", correct: true },
            { text: "התחלה: 15 דקות, שיא: שעה, שקוף", correct: false },
            { text: "ללא שיא, משך 24 שעות", correct: false },
            { text: "ניתן IV בלבד", correct: false }
        ],
        category: "סוגי אינסולין (מיקוד למבחן)",
        explanation: "NPH (Humulin N / Novolin N) — אינסולין בינוני טווח. התחלה: ~2 שעות, שיא: ~8 שעות (סיכון גבוה להיפוגליקמיה בשיא!), משך: ~16 שעות. עכור — יש לגלגל בין כפות הידיים (לא לנער). ניתן לערבב עם Regular — שואבים קודם Regular ('שקוף לפני עכור')."
    },
    {
        question: "מהם המאפיינים של אינסולין ארוך טווח (Long-Acting)?",
        options: [
            { text: "Lantus (Glargine), Tresiba (Degludec) — ללא שיא, משך ~24 שעות, אין לערבב!", correct: true },
            { text: "NPH — שיא ב-8 שעות", correct: false },
            { text: "Regular — שיא ב-2 שעות", correct: false },
            { text: "Humalog — שיא ב-1 שעה", correct: false }
        ],
        category: "סוגי אינסולין (מיקוד למבחן)",
        explanation: "אינסולין ארוך טווח: Lantus (Glargine), Levemir (Detemir), Tresiba (Degludec). התחלה: ~2 שעות, ללא שיא (פעולה אחידה), משך: ~24 שעות. יתרון: סיכון נמוך יותר להיפוגליקמיה. חשוב: אסור לערבב עם אינסולינים אחרים!"
    },
    {
        question: "מהו הכלל 'שקוף לפני עכור' (Clear before Cloudy) בהכנת אינסולין?",
        options: [
            { text: "בערבוב Regular + NPH — שואבים קודם את ה-Regular (השקוף) ואז NPH (העכור)", correct: true },
            { text: "שואבים קודם NPH ואז Regular", correct: false },
            { text: "מתייחס לצבע המחט", correct: false },
            { text: "מתייחס לרמת הסוכר", correct: false }
        ],
        category: "סוגי אינסולין (מיקוד למבחן)",
        explanation: "בערבוב Regular (שקוף) + NPH (עכור): 1) מזריקים אוויר ל-NPH, 2) מזריקים אוויר ל-Regular, 3) שואבים קודם Regular (שקוף — כדי לא לזהם אותו), 4) שואבים NPH (עכור). 'Clear before Cloudy' = R לפני N."
    },
    {
        question: "מתי הסיכון הגבוה ביותר להיפוגליקמיה?",
        options: [
            { text: "בזמן שיא הפעולה (Peak) של האינסולין", correct: true },
            { text: "מיד אחרי ההזרקה", correct: false },
            { text: "24 שעות אחרי ההזרקה", correct: false },
            { text: "רק בלילה", correct: false }
        ],
        category: "סוגי אינסולין (מיקוד למבחן)",
        explanation: "היפוגליקמיה מתרחשת בסבירות הגבוהה ביותר בזמן השיא (Peak) — כשהאינסולין בפעילות מקסימלית. Rapid: שיא ~1 שעה, Regular: שיא ~2 שעות, NPH: שיא ~8 שעות, Long-acting: ללא שיא (סיכון נמוך יותר). חשוב שהחולה יאכל בזמן!"
    },
    // ==================== DKA ו-HHS (מיקוד למבחן) ====================
    {
        question: "מהי התמונה הקלינית של DKA?",
        options: [
            { text: "נשימות קוסמאול, ריח פירותי מהפה, התייבשות, כאב בטן, בחילות, בלבול", correct: true },
            { text: "עלייה במשקל ובצקות", correct: false },
            { text: "ברדיקרדיה ועלייה בלחץ דם", correct: false },
            { text: "חום גבוה ופריחה", correct: false }
        ],
        category: "DKA ו-HHS (מיקוד למבחן)",
        explanation: "DKA — נשימות קוסמאול (עמוקות ומהירות — פיצוי על החמצת), ריח פירותי/אצטוני מהפה (קטונים), התייבשות קשה (מאוסמוטי דיורזיס), כאב בטן, בחילות והקאות, שינויים בהכרה (מבלבול עד תרדמת)."
    },
    {
        question: "מהם ערכי המעבדה האופייניים ל-DKA?",
        options: [
            { text: "סוכר > 250, pH < 7.35, HCO₃ < 18, קטונים חיוביים בדם ובשתן, Anion Gap מוגבר", correct: true },
            { text: "סוכר < 70, pH > 7.45", correct: false },
            { text: "סוכר תקין עם pH תקין", correct: false },
            { text: "סוכר > 250 עם pH > 7.45", correct: false }
        ],
        category: "DKA ו-HHS (מיקוד למבחן)",
        explanation: "DKA: גלוקוז > 250 mg/dL (בד\"כ 400-600), pH < 7.35 (חמצת), HCO₃ < 18 mEq/L, קטונים חיוביים (בדם ובשתן), Anion Gap מוגבר (> 12). בנוסף: BUN/Cr מוגברים (התייבשות), K+ מוגבר בתחילה (יוצא מתאים בחמצת) אך מאגרי K+ מדולדלים."
    },
    {
        question: "מהו סדר הטיפול ב-DKA?",
        options: [
            { text: "נוזלים IV (NaCl 0.9%) → בדיקת K+ → אינסולין Regular בטפטוף IV → ניטור אלקטרוליטים", correct: true },
            { text: "אינסולין מיד ואז נוזלים", correct: false },
            { text: "ביקרבונט מיד", correct: false },
            { text: "אנטיביוטיקה IV", correct: false }
        ],
        category: "DKA ו-HHS (מיקוד למבחן)",
        explanation: "טיפול ב-DKA: 1) נוזלים IV — NaCl 0.9% (החזרת נפח, תיקון התייבשות). 2) בדיקת K+ — אם K < 3.3 חובה לתקן לפני מתן אינסולין! 3) אינסולין Regular בטפטוף IV רציף (האינסולין היחיד שניתן IV). 4) ניטור סוכר כל שעה, אלקטרוליטים כל 2-4 שעות."
    },
    {
        question: "מדוע חשוב לבדוק אשלגן לפני מתן אינסולין ב-DKA?",
        options: [
            { text: "אינסולין מכניס K+ לתוך התאים → אם K+ כבר נמוך עלולה להיגרם היפוקלמיה מסכנת חיים", correct: true },
            { text: "אינסולין מעלה K+ בדם", correct: false },
            { text: "אשלגן לא קשור ל-DKA", correct: false },
            { text: "כדי למנוע היפרקלמיה", correct: false }
        ],
        category: "DKA ו-HHS (מיקוד למבחן)",
        explanation: "ב-DKA, K+ בדם מוגבר (יוצא מתאים בחמצת) אך מאגרי K+ הכלליים מדולדלים. אינסולין מכניס K+ חזרה לתאים → ירידה חדה ב-K+ בדם → היפוקלמיה (סכנת הפרעת קצב). לכן: אם K < 3.3 — חובה לתקן K+ לפני מתן אינסולין!"
    },
    {
        question: "מהו ההבדל בין DKA ל-HHS (Hyperosmolar Hyperglycemic State)?",
        options: [
            { text: "DKA — סוכרת 1, סוכר 250-600, קטונים+, pH נמוך; HHS — סוכרת 2, סוכר > 600, ללא קטונים, התייבשות חמורה יותר", correct: true },
            { text: "אין הבדל קליני", correct: false },
            { text: "HHS מופיע רק בילדים", correct: false },
            { text: "DKA ללא התייבשות ו-HHS עם התייבשות", correct: false }
        ],
        category: "DKA ו-HHS (מיקוד למבחן)",
        explanation: "DKA: סוכרת סוג 1 (גם 2), סוכר 250-600, קטונים חיוביים, חמצת (pH < 7.35), נשימות קוסמאול, ריח פירותי. HHS: סוכרת סוג 2, סוכר > 600 (לעיתים > 1000!), ללא קטונים, ללא חמצת, אוסמולריות > 320, התייבשות חמורה מאוד, שינויים נוירולוגיים בולטים."
    },
    // ==================== פילונפריטיס וציסטיטיס (מיקוד למבחן) ====================
    {
        question: "מה ההבדל בין ציסטיטיס (דלקת שלפוחית) לפילונפריטיס (דלקת כליה)?",
        options: [
            { text: "ציסטיטיס — דרכי שתן תחתונות, ללא חום; פילונפריטיס — מעורבות כלייתית, חום גבוה, כאב מותני", correct: true },
            { text: "אין הבדל — אותה מחלה", correct: false },
            { text: "ציסטיטיס עם חום גבוה ופילונפריטיס ללא חום", correct: false },
            { text: "ציסטיטיס רק בגברים ופילונפריטיס רק בנשים", correct: false }
        ],
        category: "פילונפריטיס וציסטיטיס (מיקוד למבחן)",
        explanation: "ציסטיטיס (UTI תחתון): דיזוריה, תכיפות, דחיפות, ללא חום, ללא כאב מותני. פילונפריטיס (UTI עליון): חום גבוה (> 39°C), כאב מותני/CVA tenderness, צמרמורות, בחילות, בנוסף לתסמיני ציסטיטיס."
    },
    {
        question: "מה נראה בסטיק שתן (Dipstick) בזיהום דרכי שתן?",
        options: [
            { text: "לויקוציטים חיובי (Leukocyte Esterase), ניטריטים חיובי, דם חיובי", correct: true },
            { text: "גלוקוז חיובי וקטונים חיובי", correct: false },
            { text: "חלבון בלבד", correct: false },
            { text: "בילירובין חיובי", correct: false }
        ],
        category: "פילונפריטיס וציסטיטיס (מיקוד למבחן)",
        explanation: "סטיק שתן ב-UTI: Leukocyte Esterase חיובי (מרמז על נוכחות WBC — דלקת), ניטריטים חיובי (חיידקים גרם-שליליים הופכים ניטראט לניטריט), דם חיובי (המטוריה). ניטריטים שלילי לא שולל UTI (לא כל החיידקים מפרקים ניטראט)."
    },
    {
        question: "מה ההבדל בממצאי המעבדה בין ציסטיטיס לפילונפריטיס?",
        options: [
            { text: "פילונפריטיס — WBC casts (גלילי לויקוציטים) באנליזת שתן, WBC מוגבר בדם, CRP מוגבר; ציסטיטיס — ללא גלילים", correct: true },
            { text: "ציסטיטיס עם WBC casts", correct: false },
            { text: "אין הבדל מעבדתי", correct: false },
            { text: "פילונפריטיס ללא WBC בשתן", correct: false }
        ],
        category: "פילונפריטיס וציסטיטיס (מיקוד למבחן)",
        explanation: "ממצאים ייחודיים לפילונפריטיס: WBC casts (גלילי לויקוציטים) — מעידים על מעורבות כלייתית (הגלילים נוצרים בטובולי הכליה). בנוסף: WBC מוגבר בדם, CRP מוגבר, תרבית דם חיובית (בקטרמיה). בציסטיטיס: WBC בשתן ללא גלילים, ספירת דם בד\"כ תקינה."
    },
    {
        question: "מהו הגורם השכיח ביותר לזיהום בדרכי שתן?",
        options: [
            { text: "E. coli — אחראי ל-~80% מה-UTI הלא-מסובכים", correct: true },
            { text: "Staphylococcus aureus", correct: false },
            { text: "Streptococcus pneumoniae", correct: false },
            { text: "Candida albicans", correct: false }
        ],
        category: "פילונפריטיס וציסטיטיס (מיקוד למבחן)",
        explanation: "E. coli (Escherichia coli) הוא הגורם ל-~80% מזיהומי דרכי השתן הלא-מסובכים. חיידק גרם-שלילי ממערכת העיכול, מגיע לשלפוחית בעיקר דרך השופכה. גורמים נוספים: Klebsiella, Proteus, Enterococcus."
    },
    // ==================== מחלת כליה כרונית (מיקוד למבחן) ====================
    {
        question: "מהם שלבי מחלת כליה כרונית (CKD) לפי eGFR?",
        options: [
            { text: "שלב 1: >90, שלב 2: 60-89, שלב 3: 30-59, שלב 4: 15-29, שלב 5: <15 (דיאליזה)", correct: true },
            { text: "רק שני שלבים — קל וחמור", correct: false },
            { text: "שלב 1: <15, שלב 5: >90", correct: false },
            { text: "אין חלוקה לשלבים", correct: false }
        ],
        category: "מחלת כליה כרונית (מיקוד למבחן)",
        explanation: "CKD stages לפי eGFR (mL/min): שלב 1 (>90 — נזק כלייתי עם GFR תקין), שלב 2 (60-89 — ירידה קלה), שלב 3a/3b (30-59 — ירידה בינונית), שלב 4 (15-29 — ירידה חמורה, הכנה לדיאליזה), שלב 5 (<15 — מחלה סופנית, דיאליזה/השתלה)."
    },
    {
        question: "מהם הסיבוכים העיקריים של CKD?",
        options: [
            { text: "אנמיה, היפרקלמיה, חמצת מטבולית, היפוקלצמיה, היפרפוספטמיה, יתר לחץ דם", correct: true },
            { text: "רק עייפות", correct: false },
            { text: "היפוקלמיה בלבד", correct: false },
            { text: "אלקלוזיס מטבולי", correct: false }
        ],
        category: "מחלת כליה כרונית (מיקוד למבחן)",
        explanation: "סיבוכי CKD: 1) אנמיה (ירידה ב-EPO), 2) היפרקלמיה (הכליה לא מפרישה K+), 3) חמצת מטבולית (הכליה לא מפרישה חומצות), 4) היפוקלצמיה + היפרפוספטמיה (הפרעה בוויטמין D → מחלת עצמות כלייתית), 5) יתר לחץ דם (עומס נוזלים), 6) אורמיה."
    },
    {
        question: "מדוע מתפתחת אנמיה ב-CKD?",
        options: [
            { text: "ירידה בייצור EPO (אריתרופויאטין) על ידי הכליות הפגועות", correct: true },
            { text: "דימום מערכת העיכול בלבד", correct: false },
            { text: "חוסר ויטמין B12", correct: false },
            { text: "חוסר חומצה פולית", correct: false }
        ],
        category: "מחלת כליה כרונית (מיקוד למבחן)",
        explanation: "הכליות מייצרות EPO (אריתרופויאטין) — הורמון המגרה ייצור כדוריות דם אדומות במח העצם. ב-CKD הכליות פגועות → ירידה ב-EPO → אנמיה. טיפול: EPO סינתטי (Epoetin alfa / Darbepoetin). יעד המוגלובין: 10-11 g/dL (לא לתקן מלא!)."
    },
    {
        question: "מהו הקשר בין סידן, זרחן, וויטמין D ב-CKD?",
        options: [
            { text: "כליה פגועה לא מפעילה ויטמין D → ספיגת Ca יורדת → Ca נמוך + P גבוה → מחלת עצמות כלייתית", correct: true },
            { text: "Ca גבוה ו-P נמוך", correct: false },
            { text: "ויטמין D עולה ב-CKD", correct: false },
            { text: "אין קשר בין סידן לזרחן", correct: false }
        ],
        category: "מחלת כליה כרונית (מיקוד למבחן)",
        explanation: "ב-CKD: 1) הכליה לא מפעילה ויטמין D (ל-1,25-dihydroxy). 2) ספיגת סידן במעי יורדת → היפוקלצמיה. 3) הכליה לא מפרישה זרחן → היפרפוספטמיה. 4) PTH עולה (היפרפאראתירואידיזם משני). 5) תוצאה: Renal Osteodystrophy — מחלת עצמות כלייתית."
    },
    // ==================== בלוטת התריס (מיקוד למבחן) ====================
    {
        question: "מהם הסימנים הקליניים של היפרתירואידיזם?",
        options: [
            { text: "טכיקרדיה, ירידה במשקל, חוסר סבילות לחום, רעד, עצבנות, אקסופתלמוס (Graves')", correct: true },
            { text: "ברדיקרדיה, עלייה במשקל, עייפות", correct: false },
            { text: "בצקת פנים ועצירות", correct: false },
            { text: "רגישות לקור ועור יבש", correct: false }
        ],
        category: "בלוטת התריס (מיקוד למבחן)",
        explanation: "היפרתירואידיזם — עודף הורמוני תריס. סימנים: טכיקרדיה, ירידה במשקל למרות תיאבון, חוסר סבילות לחום, הזעה, רעד, עצבנות, שלשולים, אקסופתלמוס (בליטת עיניים — ב-Graves'), גויטר (זפק). מעבדה: TSH נמוך, T3/T4 גבוהים."
    },
    {
        question: "מהם הסימנים הקליניים של היפותירואידיזם?",
        options: [
            { text: "ברדיקרדיה, עלייה במשקל, עייפות, רגישות לקור, עצירות, עור יבש, בצקת פנים", correct: true },
            { text: "טכיקרדיה וירידה במשקל", correct: false },
            { text: "חוסר סבילות לחום והזעה", correct: false },
            { text: "שלשולים ורעד", correct: false }
        ],
        category: "בלוטת התריס (מיקוד למבחן)",
        explanation: "היפותירואידיזם — חוסר הורמוני תריס. סימנים: ברדיקרדיה, עלייה במשקל, עייפות, רגישות לקור, עצירות, עור יבש, שיער דליל, בצקת פנים (מיקסדמה), דיכאון, חולשת שרירים. מעבדה: TSH גבוה, T3/T4 נמוכים."
    },
    {
        question: "מהו משבר תירוטוקסי (Thyroid Storm) ומה הטיפול?",
        options: [
            { text: "החמרה חמורה של היפרתירואידיזם — חום > 40°C, טכיקרדיה > 140, בלבול; טיפול: PTU, יוד, חוסמי בטא, סטרואידים", correct: true },
            { text: "ירידה בהכרה מהיפותירואידיזם", correct: false },
            { text: "אלרגיה לתרופות תריס", correct: false },
            { text: "דלקת בלוטת התריס ויראלית", correct: false }
        ],
        category: "בלוטת התריס (מיקוד למבחן)",
        explanation: "Thyroid Storm — מצב חירום מסכן חיים. חום גבוה מאוד (> 40°C), טכיקרדיה > 140, ל\"ד גבוה → קולאפס, בלבול עד תרדמת. טיפול: 1) PTU/Methimazole (מעכב ייצור הורמון), 2) יוד (מעכב שחרור), 3) חוסמי בטא (Propranolol — שולט בטכיקרדיה), 4) סטרואידים, 5) קירור."
    },
    {
        question: "מהי תרדמת מיקסדמה (Myxedema Coma) ומה הטיפול?",
        options: [
            { text: "החמרה חמורה של היפותירואידיזם — היפותרמיה, ברדיקרדיה, ירידה בהכרה; טיפול: Levothyroxine IV, חימום הדרגתי", correct: true },
            { text: "החמרה של היפרתירואידיזם", correct: false },
            { text: "אלרגיה ל-Levothyroxine", correct: false },
            { text: "דלקת בלוטת התריס חיידקית", correct: false }
        ],
        category: "בלוטת התריס (מיקוד למבחן)",
        explanation: "Myxedema Coma — מצב חירום מסכן חיים מהיפותירואידיזם חמור. היפותרמיה (T < 35°C), ברדיקרדיה, היפוטנזיה, ירידה בהכרה/תרדמת, היפוגליקמיה, היפונתרמיה. טיפול: Levothyroxine IV בולוס, חימום הדרגתי (לא מהיר — סכנת הפרעת קצב), סטרואידים IV, תמיכה נשימתית."
    },
    {
        question: "מהי התרופה העיקרית לטיפול בהיפותירואידיזם?",
        options: [
            { text: "Levothyroxine (Eltroxin/Synthroid) — T4 סינתטי, ניתן בבוקר על קיבה ריקה", correct: true },
            { text: "PTU (Propylthiouracil)", correct: false },
            { text: "Methimazole", correct: false },
            { text: "Propranolol", correct: false }
        ],
        category: "בלוטת התריס (מיקוד למבחן)",
        explanation: "Levothyroxine (T4 סינתטי) — קו ראשון בהיפותירואידיזם. ניתן בבוקר, 30-60 דקות לפני אוכל (על קיבה ריקה לספיגה מיטבית). לא לתת עם סידן, ברזל, או אנטאצידים (מפחיתים ספיגה). מעקב: TSH כל 6-8 שבועות עד יציבות."
    },
    // ==================== לבלב — העשרה (מיקוד למבחן) ====================
    {
        question: "מדוע יש להימנע ממורפין בפנקראטיטיס חריפה?",
        options: [
            { text: "מורפין עלול לגרום לכווץ סוגר Oddi ולהחמיר את החסימה", correct: true },
            { text: "מורפין גורם לשלשולים", correct: false },
            { text: "מורפין מעלה עמילאז", correct: false },
            { text: "אין סיבה — מורפין בטוח", correct: false }
        ],
        category: "לבלב (מיקוד למבחן)",
        explanation: "מורפין (ואופיואידים מסוימים) עלולים לגרום לכווץ (spasm) של סוגר Oddi — השריר שבמוצא צינור המרה-לבלב. כיווץ הסוגר מגביר את הלחץ בצינור הלבלב ומחמיר פנקראטיטיס. חלופה: Meperidine (Demerol) — פחות כיווץ של Oddi, או NSAIDs."
    },
    {
        question: "מהו ציון Ranson ומה הוא מעריך?",
        options: [
            { text: "סולם חומרה של פנקראטיטיס חריפה — ציון ≥ 3 מנבא תחלואה ותמותה גבוהות", correct: true },
            { text: "סולם לדירוג כאב", correct: false },
            { text: "סולם לדירוג CKD", correct: false },
            { text: "סולם לדירוג DKA", correct: false }
        ],
        category: "לבלב (מיקוד למבחן)",
        explanation: "Ranson Criteria — 11 קריטריונים (5 באשפוז + 6 תוך 48 שעות) לחומרת פנקראטיטיס חריפה. פרמטרים כוללים: גיל, WBC, גלוקוז, LDH, AST (באשפוז), וירידה בהמטוקריט, עליית BUN, סידן < 8, PaO₂, חוסר בסיס, הפרשת נוזלים (ב-48 שעות). ציון ≥ 3 מנבא סיבוכים חמורים."
    }
];
